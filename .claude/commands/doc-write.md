...
> ⚠️ 请提供目标文档或大纲路径，或先执行 `/load-target`：
> ```
> /doc-write /path/to/目标文档或大纲
> /doc-write /path/to/目标文档或大纲 3       # 只加载第3章
> /doc-write /path/to/目标文档或大纲 1-2     # 只加载第1、2章
> ```
> -   或先执行 `/load-outline /path/to/大纲文件`
>
